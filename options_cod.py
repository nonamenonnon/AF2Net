...
parser.add_argument('--epoch', type=int, default=170, help='epoch number')
...
parser.add_argument('--save_path', type=str, default='../autodl-tmp/xiaorong3/', help='the path to save models and logs')
